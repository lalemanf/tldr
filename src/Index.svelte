...
<main>
    ...
    <h2>
        ...
        <p>
            Una buena web para comprar este tipo de cosas es <a class="glitch" href="https://www.kubii.es/215-raspberry-pi" target="_blank" >KUBII</a>
        </p>

        <p>
            Si te va más la electrónica puedes probar con <a class="glitch" href="https://www.kubii.fr/26-arduino" target="_blank">Arduino</a> que también da muchísimo juego. Os dejo también por aquí el proyecto <a class="glitch" href="https://github.com/lupastance/Super-Memo" target="_blank">SUPER MEMO</a> que hice con esta plaquita, un pequeño juego al más puro estilo SIMÓN (el de los 4 colores).
        </p>
